...
export const DRAW_HEAVY_K = 3.20      // 국내 무배당이 이보다 낮고
export const DRAW_HEAVY_F = 3.40      // 해외 무배당도 이보다 낮으면 → 무고려 (빈도 25.1%)
export const DRAW_LIGHT_K = 3.80      // 국내 무배당이 이 이상이면 → 무제외 (빈도 23.3%)
...
// ⚠ 화면의 도움말(판정 참고표)도 이 표를 그대로 읽어 그린다 — 값을 복사해 두면
//   실측을 갱신했을 때 계산과 도움말이 갈린다(utils/pickOptions.js와 같은 이유).
export const GRADE = {
...
export const GRADE_FLIP = { 같은편: [81.1, 834], 무관: [77.0, 939], 중립: [77.9, 1629], 상충: [73.0, 274] }
