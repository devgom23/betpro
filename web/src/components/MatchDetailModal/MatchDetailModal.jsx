...
const DIR_HIT = {
  init: {
    ...
    diffFor: {
      정무: { '~1.5': [87, 657, 89, -1.9, 1], '1.5~1.8': [79, 1133, 80, -0.5, 0], '1.8~2.2': [76, 1310, 72, 2.7, 1], '2.2+': [69, 302, 68, 0.4, 0] },
      정역: { '~1.5': [83, 234, 82, 0.5, 0], '1.5~1.8': [73, 567, 74, -0.5, 0], '1.8~2.2': [73, 924, 71, 0.9, 0], '2.2+': [75, 337, 69, 2.3, 0] },
      플핸무: { '~1.5': [68, 177, 53, 4.0, 1], '1.5~1.8': [72, 715, 71, 0.5, 0], '1.8~2.2': [79, 1325, 78, 0.7, 0], '2.2+': [83, 429, 84, -0.6, 0] },
      플핸승: { '~1.5': [76, 860, 75, 0.4, 0], '1.5~1.8': [75, 1066, 75, 0.2, 0], '1.8~2.2': [77, 983, 77, -0.4, 0], '2.2+': [86, 203, 78, 2.5, 1] },
      정: { '~1.5': [76, 227, 71, 1.6, 0] },
    },
  },
  final: {
    same: {
    ...
    diffFor: {
      정무: { '~1.5': [89, 731, 89, 0.2, 0], '1.5~1.8': [78, 1237, 79, -1.4, 0], '1.8~2.2': [75, 1302, 72, 2.0, 1], '2.2+': [68, 262, 68, -0.0, 0] },
      정역: { '~1.5': [77, 210, 82, -1.9, 1], '1.5~1.8': [75, 590, 74, 0.5, 0], '1.8~2.2': [72, 892, 71, 0.1, 0], '2.2+': [67, 323, 69, -1.0, 0] },
      플핸무: { '~1.5': [50, 164, 54, -0.9, 1], '1.5~1.8': [70, 704, 71, -0.5, 0], '1.8~2.2': [79, 1166, 79, 0.4, 0], '2.2+': [85, 431, 84, 0.8, 0] },
      플핸승: { '~1.5': [76, 846, 75, 0.7, 0], '1.5~1.8': [73, 974, 75, -1.4, 0], '1.8~2.2': [77, 896, 77, -0.5, 0], '2.2+': [75, 249, 79, -1.4, 0] },
      정: { '~1.5': [77, 308, 71, 2.4, 0] },
    },
  },
}
